...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var gravityMultiplier: Double = 1;
    var oof = SKAction.playSoundFileNamed("sounds/oof.mp3", waitForCompletion: false)
    ...
    func setGravityMultiplier(value: CGFloat) {
        self.gravityMultiplier = Double(value);
//        self.gravity *= self.gravityMultiplier;
    }
...
//                print(pos)
    ...
    func startReadingMotionData() {
        ...
        motionManager.startDeviceMotionUpdates(to: opQueue) {
            ...
            if let mydata = data {
                self.gravity = CGVector(dx: mydata.gravity.x * self.gravityMultiplier * 10, dy: mydata.gravity.y * self.gravityMultiplier * 10)
